# This script takes data of energy consumption and makes an xy plot with the
...
# and set the font size in 12. The plot will be saved as "plot2.png" in the current
# directory
